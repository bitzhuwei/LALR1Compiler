...
{
    /// <summary>
    /// 经过优化的LR(1)Edge列表。插入新元素用二分法，速度更快，但使用者不能控制元素的位置。
    /// </summary>
    public class LALR1EdgeCollection : OrderedCollection<LALR1Edge>
    {

        public LALR1StateCollection StateCollection { get; private set; }
        ...
        public LALR1EdgeCollection(LALR1StateCollection stateCollection, params LALR1Edge[] edges)
