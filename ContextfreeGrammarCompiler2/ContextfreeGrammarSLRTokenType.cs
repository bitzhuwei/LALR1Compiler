namespace ContextfreeGrammarCompiler2
{
    ...
    public class ContextfreeGrammarSLRTokenType
    {
        
        public const string NODE__coloncolonequalLeave__ = "__coloncolonequal";
        ...
        public const string NODE__nullLeave__ = "__null";
        
        public const string NODE__identifierLeave__ = "__identifier";
        
        public const string NODE__numberLeave__ = "__number";
        
        public const string NODE__constStringLeave__ = "__constString";
        
        public const string NODE__userDefinedTypeLeave__ = "__userDefinedType";
        
        public const string NODEconstStringLeave__ = "constString";
    }
}
